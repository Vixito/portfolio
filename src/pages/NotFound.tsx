...
function NotFound() {
  ...
  useEffect(() => {
    // Ajustar altura del skybox a múltiplo de 32
    if (skyboxRef.current) {
      const h = skyboxRef.current.offsetHeight;
      const s_h = Math.round(h / 32) * 32;
      skyboxRef.current.style.height = `${s_h}px`;
    }

    // Animación del personaje caminando
  ...
  return (
    <div className="flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        {/* Personaje caminando */}
        <div ref={playerRef} id="player" className="idle" />
